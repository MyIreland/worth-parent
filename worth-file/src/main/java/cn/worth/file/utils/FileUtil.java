...
public class FileUtil extends cn.hutool.core.io.FileUtil {
     ...
     * 音频类型
     */
    public static Map<String, String> audioTypeMap = new HashMap<>();
    static {
     ...
     * 压缩包类型
     */
    public static Map<String, String> zipTypeMap = new HashMap<>();
    static {
     ...
     * 图片类型
     */
    public static Map<String, String> imageTypeMap = new HashMap<>();
    static {
