...
public class BizMemberLevel extends Model<BizMemberLevel> {
    ...
    public String toString() {
        ...
        ", privilegeFreeFreight=" + privilegeFreeFreight +
        ", privilegeSignIn=" + privilegeSignIn +
        ", privilegeComment=" + privilegeComment +
        ", privilegePromotion=" + privilegePromotion +
        ", privilegeMemberPrice=" + privilegeMemberPrice +
        ", privilegeBirthday=" + privilegeBirthday +
